...
- `ttk_runs_fixed/superlevel_topology/superlevel_pd_mt_per_sample.csv` — per-sample PD/MT distances, one row per (method, sample)
- `ttk_runs_fixed/superlevel_topology/superlevel_summary_by_method.csv` — per-method summary statistics
- `ttk_runs_fixed/superlevel_topology/superlevel_winner_comparison.csv` — per-sample PD/MT winner across all completed methods
- `docs/superlevel_topology_robustness_eval.md` — this report
