#!/usr/bin/env python3
"""
Candidate E2-tf-lowlambda-expanded-2688: scale-up of the completed
candidateE2_tf_lowlambda_expanded672 run to 2688 training samples, using the
...
C-expanded-2688 and the completed candidateB_plus_E2_tf_lowlambda_expanded2688
...
candidateB_plus_E2_tf_lowlambda_expanded2688 script. Same PhIRE/TensorFlow
...
Workflow:
  Phase 1 -- Training: fine-tune the pretrained vector [u,v] CNN for 3
             ...
             Output: models_fixed/topology_finetuning/
                       wind_finetune_candidateE2_tf_lowlambda_expanded2688/
  Phase 2 -- Evaluation: paired inference on the 168-sample benchmark via
             PhIREGANs.test_paired(), unchanged from Candidate C.
             Output: data_out/wind_finetune_candidateE2_tf_lowlambda_expanded2688/
...
Usage (from repo root, on Spark):
  python3 scripts/run_candidateE2_tf_lowlambda_expanded2688_ttkcrit_refiner.py

Next steps (not run by this script):
  Cheap scalar/domain evaluation:
    python3 scripts/evaluate_finetune_candidate.py \\
      --candidate-name candidateE2_tf_lowlambda_expanded2688 \\
      --candidate-dir  data_out/wind_finetune_candidateE2_tf_lowlambda_expanded2688 \\
      ...
      --out-dir        ttk_runs_fixed/topology_finetuning/candidateE2_tf_lowlambda_expanded2688_eval
  ...
  the distances/comparison report are needed for this scale-up):
    bash scripts/run_candidate_topology_pipeline.sh \\
      --method     candidateE2_tf_lowlambda_expanded2688 \\
      --data-dir   data_out/wind_finetune_candidateE2_tf_lowlambda_expanded2688 \\
      --vti-dir    ttk_runs_fixed/topology_finetuning/candidateE2_tf_lowlambda_expanded2688_topology_vti \\
      --out-base   ttk_runs_fixed/topology_finetuning/candidateE2_tf_lowlambda_expanded2688_topology \\
      --n-samples  168 \\
      --threads    1 \\
      --skip-viz
"""
...
# ---------------------------------------------------------------------------
LOG_PATH = REPO_ROOT / 'logs' / 'wind_finetune_candidateE2_tf_lowlambda_expanded2688.log'
...
MODEL_OUT = 'models_fixed/topology_finetuning/wind_finetune_candidateE2_tf_lowlambda_expanded2688'
DATA_OUT  = 'data_out/wind_finetune_candidateE2_tf_lowlambda_expanded2688'
...
_PROTECTED = [
    ...
    # The sibling 1344-scale C+E2 script's output/constraints -- defense
...
def main() -> None:
    ...
    print('=' * 64)
    print('Candidate E2-tf-lowlambda-expanded-2688 fine-tuning')
    print('=' * 64)
    ...
    phire = PhIREGANs(
        data_type    = 'wind_finetune_candidateE2_tf_lowlambda_expanded2688',
    ...
    print('      --candidate-name candidateE2_tf_lowlambda_expanded2688 \\')
    print('      --candidate-dir  data_out/wind_finetune_candidateE2_tf_lowlambda_expanded2688 \\')
    ...
    print('      --out-dir        ttk_runs_fixed/topology_finetuning/candidateE2_tf_lowlambda_expanded2688_eval')
    print()
    ...
    print('      --method     candidateE2_tf_lowlambda_expanded2688 \\')
    print('      --data-dir   data_out/wind_finetune_candidateE2_tf_lowlambda_expanded2688 \\')
    print('      --vti-dir    ttk_runs_fixed/topology_finetuning/candidateE2_tf_lowlambda_expanded2688_topology_vti \\')
    print('      --out-base   ttk_runs_fixed/topology_finetuning/candidateE2_tf_lowlambda_expanded2688_topology \\')
    print('      --n-samples  168 \\')
    print('      --threads    1 \\')
    print('      --skip-viz')
    print('=' * 64)
