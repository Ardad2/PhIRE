#!/usr/bin/env python3
"""
CandidateE2-fixed-lowlambda-expanded-2688: PyTorch residual refiner with
TTK critical-pair loss, trained on the 2688-sample expanded seasonal
...
original 0.04/0.02) and 2688-sample-scale paths substituted throughout.
...
Workflow:
  Phase 1 — Training:  train RefinerNet on 2688 expanded CNN SR outputs
            Input:  data_out/wind_mrhr_cnn_expanded2688/  (dataSR.npy, dataGT.npy)
            ...
            Output: models_fixed/topology_finetuning/
                      wind_finetune_candidateE2_fixed_lowlambda_expanded2688/
  ...
  Phase 2 — Evaluation: apply trained refiner to 168-sample benchmark CNN SR
            ...
            Output: data_out/wind_finetune_candidateE2_fixed_lowlambda_expanded2688/
...
TRAIN_CNN_DIR   = REPO_ROOT / "data_out" / "wind_mrhr_cnn_expanded2688"
...
OUT_DIR  = REPO_ROOT / "data_out" / "wind_finetune_candidateE2_fixed_lowlambda_expanded2688"
LOG_PATH = REPO_ROOT / "logs"    / "wind_finetune_candidateE2_fixed_lowlambda_expanded2688.log"
...
_PROTECTED = [
    ...
    REPO_ROOT / "data_out"       / "wind_finetune_candidateE2_fixed_lowlambda_expanded1344",
    ...
    REPO_ROOT / "models_fixed"   / "topology_finetuning" / "wind_finetune_candidateE2_fixed_lowlambda_expanded1344",
    ...
    REPO_ROOT / "ttk_runs_fixed" / "topology_finetuning" / "candidateE2_fixed_lowlambda_expanded1344_constraints",
    REPO_ROOT / "ttk_runs_fixed" / "topology_finetuning" / "candidateE2_fixed_lowlambda_expanded1344_vti",
    REPO_ROOT / "example_data_fixed",
    REPO_ROOT / "example_data_topology_expanded_672",
    REPO_ROOT / "example_data_topology_expanded_1344",
]
...
def main() -> None:
    ...
    print("=" * 64)
    print("CandidateE2-fixed-lowlambda-expanded-2688  TTK Critical-Pair Refiner")
    print("=" * 64)
    ...
    # ── Load training data (2688 expanded) ────────────────────────────────
    ...
    print("\n" + "=" * 64)
    print("CandidateE2-fixed-lowlambda-expanded-2688 complete.")
