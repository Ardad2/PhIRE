#!/usr/bin/env python3
"""
Candidate E2-tf-lowlambda-expanded-672: repaired TTK fixed-index critical-pair
losses implemented directly in the original PhIRE/TensorFlow fine-tuning path
(sr_network.SR_NETWORK), trained on the same 672-sample expanded seasonal
dataset as Candidate C-expanded-672, evaluated on the 168-sample benchmark.

This is the apples-to-apples TF counterpart to the PyTorch residual-refiner
Candidate E2-low: same architecture (fine-tunes the actual generator, not a
frozen-CNN post-hoc residual head), same optimizer/epochs/batch size/data as
Candidate C-expanded-672, with TTK fixed-index losses (L_ttkcv, L_ttkpers)
added on top of the Candidate C loss stack.
...
Workflow:
  Phase 1 -- Training: fine-tune the pretrained vector [u,v] CNN for 3
             ...
             Output: models_fixed/topology_finetuning/
                       wind_finetune_candidateE2_tf_lowlambda_expanded672/
  Phase 2 -- Evaluation: paired inference on the 168-sample benchmark via
             PhIREGANs.test_paired(), unchanged from Candidate C.
             Output: data_out/wind_finetune_candidateE2_tf_lowlambda_expanded672/
...
Usage (from repo root, on Spark):
  python3 scripts/run_candidateE2_tf_lowlambda_expanded672_ttkcrit_refiner.py

Next steps (not run by this script):
  Cheap scalar/domain evaluation:
    python3 scripts/evaluate_finetune_candidate.py \\
      --candidate-name candidateE2_tf_lowlambda_expanded672 \\
      --candidate-dir  data_out/wind_finetune_candidateE2_tf_lowlambda_expanded672 \\
      ...
      --out-dir        ttk_runs_fixed/topology_finetuning/candidateE2_tf_lowlambda_expanded672_eval
  ...
  topology pipeline:
    bash scripts/run_candidate_topology_pipeline.sh \\
      ...
      --data-dir data_out/wind_finetune_candidateE2_tf_lowlambda_expanded672
"""
...
# ---------------------------------------------------------------------------
LOG_PATH = REPO_ROOT / 'logs' / 'wind_finetune_candidateE2_tf_lowlambda_expanded672.log'
...
MODEL_OUT = 'models_fixed/topology_finetuning/wind_finetune_candidateE2_tf_lowlambda_expanded672'
DATA_OUT  = 'data_out/wind_finetune_candidateE2_tf_lowlambda_expanded672'
...
def main() -> None:
    ...
    print('=' * 64)
    print('Candidate E2-tf-lowlambda-expanded-672 fine-tuning')
    print('=' * 64)
    ...
    phire = PhIREGANs(
        data_type    = 'wind_finetune_candidateE2_tf_lowlambda_expanded672',
    ...
    print('      --candidate-name candidateE2_tf_lowlambda_expanded672 \\')
    print('      --candidate-dir  data_out/wind_finetune_candidateE2_tf_lowlambda_expanded672 \\')
    ...
    print('      --out-dir        ttk_runs_fixed/topology_finetuning/candidateE2_tf_lowlambda_expanded672_eval')
    print()
    ...
    print('      --method   candidateE2_tf_lowlambda_expanded672 \\')
    print('      --data-dir data_out/wind_finetune_candidateE2_tf_lowlambda_expanded672')
    print('=' * 64)
