#!/usr/bin/env python3
"""
Candidate B+E2-tf-lowlambda-expanded-1344: scale-up of the completed
candidateB_plus_E2_tf_lowlambda_expanded672 ablation to 1344 training samples,
...
C-expanded-1344 and the completed candidateB_plus_E2_tf_lowlambda_expanded672
...
Workflow:
  Phase 1 -- Training: fine-tune the pretrained vector [u,v] CNN for 3
             ...
             Output: models_fixed/topology_finetuning/
                       wind_finetune_candidateB_plus_E2_tf_lowlambda_expanded1344/
  Phase 2 -- Evaluation: paired inference on the 168-sample benchmark via
             PhIREGANs.test_paired(), unchanged from Candidate C.
             Output: data_out/wind_finetune_candidateB_plus_E2_tf_lowlambda_expanded1344/
...
Usage (from repo root, on Spark):
  python3 scripts/run_candidateB_plus_E2_tf_lowlambda_expanded1344_ttkcrit_refiner.py

Next steps (not run by this script):
  Cheap scalar/domain evaluation:
    python3 scripts/evaluate_finetune_candidate.py \\
      --candidate-name candidateB_plus_E2_tf_lowlambda_expanded1344 \\
      --candidate-dir  data_out/wind_finetune_candidateB_plus_E2_tf_lowlambda_expanded1344 \\
      ...
      --out-dir        ttk_runs_fixed/topology_finetuning/candidateB_plus_E2_tf_lowlambda_expanded1344_eval
  ...
  the distances/comparison report are needed for this ablation):
    bash scripts/run_candidate_topology_pipeline.sh \\
      --method     candidateB_plus_E2_tf_lowlambda_expanded1344 \\
      --data-dir   data_out/wind_finetune_candidateB_plus_E2_tf_lowlambda_expanded1344 \\
      --vti-dir    ttk_runs_fixed/topology_finetuning/candidateB_plus_E2_tf_lowlambda_expanded1344_topology_vti \\
      --out-base   ttk_runs_fixed/topology_finetuning/candidateB_plus_E2_tf_lowlambda_expanded1344_topology \\
      --n-samples  168 \\
      --threads    1 \\
      --skip-viz
"""
...
# ---------------------------------------------------------------------------
LOG_PATH = REPO_ROOT / 'logs' / 'wind_finetune_candidateB_plus_E2_tf_lowlambda_expanded1344.log'
...
MODEL_OUT = 'models_fixed/topology_finetuning/wind_finetune_candidateB_plus_E2_tf_lowlambda_expanded1344'
DATA_OUT  = 'data_out/wind_finetune_candidateB_plus_E2_tf_lowlambda_expanded1344'
...
_PROTECTED = [
    ...
    # The sibling 2688-scale B+E2 script's output/constraints -- defense in
...
# ---------------------------------------------------------------------------
# Candidate B loss weights: identical to Candidate C-expanded-1344 except
...
def main() -> None:
    ...
    print('=' * 64)
    print('Candidate B+E2-tf-lowlambda-expanded-1344 fine-tuning (L_crit ablation)')
    print('=' * 64)
    ...
    phire = PhIREGANs(
        data_type    = 'wind_finetune_candidateB_plus_E2_tf_lowlambda_expanded1344',
    ...
    print('      --candidate-name candidateB_plus_E2_tf_lowlambda_expanded1344 \\')
    print('      --candidate-dir  data_out/wind_finetune_candidateB_plus_E2_tf_lowlambda_expanded1344 \\')
    ...
    print('      --out-dir        ttk_runs_fixed/topology_finetuning/candidateB_plus_E2_tf_lowlambda_expanded1344_eval')
    print()
    ...
    print('      --method     candidateB_plus_E2_tf_lowlambda_expanded1344 \\')
    print('      --data-dir   data_out/wind_finetune_candidateB_plus_E2_tf_lowlambda_expanded1344 \\')
    print('      --vti-dir    ttk_runs_fixed/topology_finetuning/candidateB_plus_E2_tf_lowlambda_expanded1344_topology_vti \\')
    print('      --out-base   ttk_runs_fixed/topology_finetuning/candidateB_plus_E2_tf_lowlambda_expanded1344_topology \\')
    print('      --n-samples  168 \\')
    print('      --threads    1 \\')
    print('      --skip-viz')
    print('=' * 64)
