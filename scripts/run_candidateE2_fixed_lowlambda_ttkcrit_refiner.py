...
Workflow:
  Phase 1 — Training:  train RefinerNet on 672 expanded CNN SR outputs
            ...
            Output: models_fixed/topology_finetuning/
                      wind_finetune_candidateE2_fixed_lowlambda/
  ...
  Phase 2 — Evaluation: apply trained refiner to 168-sample benchmark CNN SR
            ...
            Output: data_out/wind_finetune_candidateE2_fixed_lowlambda/
...
OUT_DIR  = REPO_ROOT / "data_out" / "wind_finetune_candidateE2_fixed_lowlambda"
LOG_PATH = REPO_ROOT / "logs"    / "wind_finetune_candidateE2_fixed_lowlambda.log"
