#!/usr/bin/env python3
"""
Candidate UV+E2-tf-lowlambda-expanded-2688: scale-up of the completed
candidateUV_plus_E2_tf_lowlambda_expanded672 run to 2688 training samples,
...
Candidate C-expanded-2688, candidateB_plus_E2_tf_lowlambda_expanded2688, and
candidateE2_tf_lowlambda_expanded2688, following the same 672->1344->2688
...
this scale-up tests whether that MT signal persists at 2688 samples. Same
...
residual head) as Candidate C-expanded-2688 and candidateUV_plus_E2_tf_
...
gradient/level-set scaffold. This 2688-sample run tests whether that
conclusion holds at a larger training scale:
  - If UV+E2-low remains MT-strong at 2688 samples, repaired fixed-index TTK
    supervision is robustly MT-oriented even without Candidate B, across
    scale.
  - If UV+E2-low weakens at 2688 samples relative to the 672 result, the
...
Workflow:
  Phase 1 -- Training: fine-tune the pretrained vector [u,v] CNN for 3
             ...
             Output: models_fixed/topology_finetuning/
                       wind_finetune_candidateUV_plus_E2_tf_lowlambda_expanded2688/
  Phase 2 -- Evaluation: paired inference on the 168-sample benchmark via
             PhIREGANs.test_paired(), unchanged from Candidate C.
             Output: data_out/wind_finetune_candidateUV_plus_E2_tf_lowlambda_expanded2688/
...
Usage (from repo root, on Spark):
  python3 scripts/run_candidateUV_plus_E2_tf_lowlambda_expanded2688_ttkcrit_refiner.py

Next steps (not run by this script):
  Cheap scalar/domain evaluation:
    python3 scripts/evaluate_finetune_candidate.py \\
      --candidate-name candidateUV_plus_E2_tf_lowlambda_expanded2688 \\
      --candidate-dir  data_out/wind_finetune_candidateUV_plus_E2_tf_lowlambda_expanded2688 \\
      ...
      --out-dir        ttk_runs_fixed/topology_finetuning/candidateUV_plus_E2_tf_lowlambda_expanded2688_eval
  ...
  the distances/comparison report are needed for this ablation):
    bash scripts/run_candidate_topology_pipeline.sh \\
      --method     candidateUV_plus_E2_tf_lowlambda_expanded2688 \\
      --data-dir   data_out/wind_finetune_candidateUV_plus_E2_tf_lowlambda_expanded2688 \\
      --vti-dir    ttk_runs_fixed/topology_finetuning/candidateUV_plus_E2_tf_lowlambda_expanded2688_topology_vti \\
      --out-base   ttk_runs_fixed/topology_finetuning/candidateUV_plus_E2_tf_lowlambda_expanded2688_topology \\
      --n-samples  168 \\
      --threads    1 \\
      --skip-viz
"""
...
# ---------------------------------------------------------------------------
LOG_PATH = REPO_ROOT / 'logs' / 'wind_finetune_candidateUV_plus_E2_tf_lowlambda_expanded2688.log'
...
# and candidateB_plus_E2_tf_lowlambda_expanded2688 -- reused unchanged.
...
# the exact same file used by candidateB_plus_E2_tf_lowlambda_expanded2688 and
# candidateE2_tf_lowlambda_expanded2688 (same 2688-sample training scale).
CONSTRAINTS_NPZ = (
...
MODEL_OUT = 'models_fixed/topology_finetuning/wind_finetune_candidateUV_plus_E2_tf_lowlambda_expanded2688'
DATA_OUT  = 'data_out/wind_finetune_candidateUV_plus_E2_tf_lowlambda_expanded2688'
...
_PROTECTED = [
    ...
    # The sibling 1344-scale UV+E2 script's output -- defense in depth
...
def main() -> None:
    ...
    print('=' * 64)
    print('Candidate UV+E2-tf-lowlambda-expanded-2688 fine-tuning (Candidate B scaffold ablation)')
    print('=' * 64)
    ...
    phire = PhIREGANs(
        data_type    = 'wind_finetune_candidateUV_plus_E2_tf_lowlambda_expanded2688',
    ...
    # Identical to candidateB_plus_E2_tf_lowlambda_expanded2688 -- TTK losses
    ...
    print('      --candidate-name candidateUV_plus_E2_tf_lowlambda_expanded2688 \\')
    print('      --candidate-dir  data_out/wind_finetune_candidateUV_plus_E2_tf_lowlambda_expanded2688 \\')
    ...
    print('      --out-dir        ttk_runs_fixed/topology_finetuning/candidateUV_plus_E2_tf_lowlambda_expanded2688_eval')
    print()
    ...
    print('      --method     candidateUV_plus_E2_tf_lowlambda_expanded2688 \\')
    print('      --data-dir   data_out/wind_finetune_candidateUV_plus_E2_tf_lowlambda_expanded2688 \\')
    print('      --vti-dir    ttk_runs_fixed/topology_finetuning/candidateUV_plus_E2_tf_lowlambda_expanded2688_topology_vti \\')
    print('      --out-base   ttk_runs_fixed/topology_finetuning/candidateUV_plus_E2_tf_lowlambda_expanded2688_topology \\')
    print('      --n-samples  168 \\')
    print('      --threads    1 \\')
    print('      --skip-viz')
    print('=' * 64)
