...
class PhIREGANs:
    ...
    def pretrain(self, r, data_path, model_path=None, batch_size=100, phys_cfg=None):
        '''
            ...
            inputs:
                ...
                phys_cfg   - (PhysicsLossConfig | None) optional auxiliary physics/topology losses.
                             None or PhysicsLossConfig(use_aux_losses=False) → baseline behaviour unchanged.
        ...
        # Announce active auxiliary losses (if any).
        _diag = phys_cfg is not None and phys_cfg.use_aux_losses
        if _diag:
            print(
                ...
                try:
                    ...
                    while True:
                        ...
                        if (iters % self.print_every) == 0:
                            ...
                            if _diag and model.loss_breakdown is not None:
                                bv = sess.run(model.loss_breakdown,
                                              feed_dict={x_HR: batch_HR, x_LR: batch_LR})
